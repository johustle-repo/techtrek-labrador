            ...
            <div className="auth-page min-h-[100svh] w-full overflow-y-auto lg:grid lg:grid-cols-2 font-['Instrument_Sans']">
                <div className="relative hidden h-full flex-col justify-between overflow-hidden bg-slate-900 p-12 text-white lg:flex">
                    ...
                    <div className="relative z-20 max-w-sm">
                        ...
                        <h2 className="text-3xl font-bold leading-tight text-white drop-shadow-sm">Set a strong password to keep your account protected.</h2>
                    </div>
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <div className="relative group">
                                                ...
                                                <Input
                                                    ...
                                                    value={email}
                                                    readOnly
                                                    className="pl-10 h-11 border-slate-200 bg-slate-100 text-slate-500 cursor-not-allowed rounded-lg"
                                                />
                                            </div>
