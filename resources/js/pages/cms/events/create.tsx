...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/cms/events/create' },
];

export default function EventsCreate({ attractions }: Props) {
    ...
    const submit = (e: FormEvent) => {
        e.preventDefault();
        post('/cms/events', { forceFormData: true });
    };
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="grid gap-2 md:col-span-2">
                            ...
                            <p className="text-xs text-muted-foreground">
                                Upload the same image you use for tarpaulin or
                                Facebook event posting. Recommended: 1200x628 or
                                1080x1080.
                            </p>
